...
\xdef\manvers{$Revision: 1.1.0 $}  % For use in headers, footers too
@end tex
...
This is Edition 1.1.0, August 1999,
...
@sp 1
@c !!set edition, date, version
@subtitle Edition 1.1.0, for HP2XX version 3.3.x
...
@c !!set edition, date, version
This is Edition 1.1.0, August 1999, for HP2XX Version 3.3.x
@end ifinfo
...
HP-GL/2, these are interpreted to allow up to 255 pens. 
...
@item Ian MacPhedran
Color / binary format for pbm, xfig format
