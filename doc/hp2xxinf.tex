...
@c Copyright (c) 1992 1993 Heinz W. Werntges
@c %**start of header
...
\xdef\manvers{$Revision: 1.0.3 $}  % For use in headers, footers too
@end tex
...
@c 93/11/15  V 1.04  HWW  Typos fixed
...
This is Edition 1.0.3, September 1993,
...
@sp 1
@c !!set edition, date, version
@subtitle Edition 1.0.3, for HP2XX version 3.1.x
...
Copyright @copyright{} 1992, 1993 Heinz W. Werntges
...
@c !!set edition, date, version
This is Edition 1.0.3, September 1993, for HP2XX Version 3.1.x
@end ifinfo
...
@xref{Appendix B} for a list of all colors. E.g., color 3 is green,
and color 7 means yellow. Permitted pen sizes are 0 ... 9 units.
WARNING: In raster modes, all pen sizes larger than 4 units (pixels) will be
clipped to 4 units!
...
Defaults are @var{c-string} = @var{s-string} = @samp{11111111}.
...
@code{hp2xx} currently features just one character set (set 0).
