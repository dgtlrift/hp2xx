...
@c !!set edition, date, version
This is Edition 1.3, July 2002, for HP2XX Version 3.4.3
@end ifinfo
...
been substantially improved and should render accurate pen widths. 
...
become a common denominator for the exchange of vector data.
...
Currently @code{hp2xx} will not work with such printers.
